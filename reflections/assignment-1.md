...
capacity of 5.00 million barrels a day when the repo says 3.2. The reviewing
session turned out to be wrong four times, all four about how a browser behaves.
...
the page announces exactly as before, and it stays green if someone adds a
second live region later — which would make a screen reader read everything
twice. The new test fails on both.
